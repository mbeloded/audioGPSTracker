...
public class GPSStateManager {
	...
	public void buildGPSEnableDialog() {
		String dialogMessage = mActivity.getResources().getString(
				R.string.gps_dialog_message);
		String positive_button_text = mActivity.getResources().getString(
				R.string.gps_dialog_positive_button);
		String negative_button_text = mActivity.getResources().getString(
				R.string.gps_dialog_negative_button);

		AlertDialog.Builder gpsDialog = new AlertDialog.Builder(mActivity);
		gpsDialog.setMessage(dialogMessage);
		gpsDialog.setPositiveButton(positive_button_text,
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						mActivity
								.startActivityForResult(gpsSettingsIntent, 911);

					}
				});
		gpsDialog.setNegativeButton(negative_button_text,
				new DialogInterface.OnClickListener() {
